...
public struct FBURLEncoding: ParameterEncoding {
    ...
    public static var `default`: FBURLEncoding { return FBURLEncoding() }
    
    /// Returns a `URLEncoding` instance with a `.methodDependent` destination.
    public static var methodDependent: FBURLEncoding { return FBURLEncoding() }
    
    /// Returns a `URLEncoding` instance with a `.queryString` destination.
    public static var queryString: FBURLEncoding { return FBURLEncoding(destination: .queryString) }
    
    /// Returns a `URLEncoding` instance with an `.httpBody` destination.
    public static var httpBody: FBURLEncoding { return FBURLEncoding(destination: .httpBody) }
    ...
    public func queryComponents(fromKey key: String, value: Any) -> [(String, String)] {
        ...
        if let dictionary = value as? [String: Any] {
            ...
            components += queryComponents(fromKey: "\(key)", value: array.joined(separator: ","))
